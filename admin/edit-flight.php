				    ...
				    <div class=" form-grids row form-grids-right">
						<div class="widget-shadow " data-example-id="basic-forms"> 
							<div class="form-title">
								<h4>Update Flight Location:</h4>
							</div>
							<div class="form-body">
								<form class="form-horizontal" action="processes.php?action=edit-flight" method="post"> 
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label"><strong>Flight Number: </strong></label>	
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" name="Location" id="Location" class="form-control1" placeholder="Update Status" required>
										</div>
									</div> 
